...
Here, we provide additional code to plot the raw power spectra. In this case, we can transform data from wide to long format, and then plot individual (gray) and group averaged (blue) power across frequencies. 
```{r}
